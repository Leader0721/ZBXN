 ...
 * @author ChaiHongwei
 */
public class PullToRefreshSwipeListView extends SwipeRefreshLayout
        implements
        OnScrollListener {
    private static final String TAG = PullToRefreshSwipeListView.class
            .getSimpleName();
    /**
     * 列表视图
     */
    ...
    private void init(Context context) {
        mListView = new SwipeListView(context, R.id.layout_back, R.id.layout_front);
        ...
        //必须加这句禁用下拉刷新 否则下拉时会与swipelistview左右滑动冲突
    ...
    public boolean canChildScrollUp() {
        final SwipeListView listView = getListView();
    ...
    public void setSwipeListViewListener(BaseSwipeListViewListener listener) {
        mListView.setSwipeListViewListener(listener);
    }
