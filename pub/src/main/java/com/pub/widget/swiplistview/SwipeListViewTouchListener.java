...
package com.pub.widget.swiplistview;
...
public class SwipeListViewTouchListener implements View.OnTouchListener {
     ...
     *
     * @param view      affected view
     * @param swap      If state should change. If "false" returns to the original
     *                  position
     * @param swapRight If swap is true, this parameter tells if move is to the right
     *                  or left
     * @param position  Position of list
     */
     ...
     *
     * @param view      affected view
     * @param swap      If will change state. If is "false" returns to the original
     *                  position
     * @param swapRight If swap is true, this parameter tells if move is to the right
     *                  or left
     * @param position  Position of list
