...
public class ScheduleRuleEntity implements Parcelable {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeList(this.participantUserList);
        dest.writeList(this.shareUserList);
        dest.writeString(this.shareIsEdit);
        dest.writeInt(this.participantISAlarm);
    }
    ...
    protected ScheduleRuleEntity(Parcel in) {
        ...
        this.participantUserList = new ArrayList<ScheduleDetailEntity>();
        in.readList(participantUserList, ScheduleDetailEntity.class.getClassLoader());
        this.shareUserList = new ArrayList<ScheduleDetailEntity>();
        in.readList(shareUserList, ScheduleDetailEntity.class.getClassLoader());
        this.shareIsEdit = in.readString();
        this.participantISAlarm = in.readInt();
