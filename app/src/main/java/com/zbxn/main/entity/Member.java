...
import com.pub.utils.ConfigUtils.KEY;
...
import static com.pub.utils.PreferencesUtils.getString;
...
/*
    *//**
    ...
    public void login(Context context, final String userName, final String password, final ICustomListener listener) {
        ...
        Call call = HttpRequest.getIResourceOA().LoginNetInfo(userName,password,"android",StringUtils.getPushGuid(context));
