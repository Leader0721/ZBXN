...
/**
 * Created by Wuzy on 2016/9/9.
 */
public class ZmsCompanyListEntity {
    @Expose
    ...
    public void setHandlerduty(String handlerduty) {
        this.handlerduty = handlerduty;
    }
    ...
    public void setHandlergender(String handlergender) {
