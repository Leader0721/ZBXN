...
public class PopupWindowType extends PopupWindow {
    ...
    private long mFlag;
    private PopupwindowTypeListAdapter adapter;
    ...
    public PopupWindowType(final Activity context, View view, float width, OnItemClickListener listener,
                           List<ApprovalEntity> list, String type, long flag, int flagNum) {
        ...
        if (adapter == null) {
            adapter = new PopupwindowTypeListAdapter(context, mList, flagNum);
