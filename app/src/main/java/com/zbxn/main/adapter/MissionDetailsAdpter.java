 ...
 */
public class MissionDetailsAdpter extends BaseAdapter {
    ...
    public MissionDetailsAdpter(Context mContext, List<MissionDetailEntity> mList, DeleteChildCallback callback, boolean isCanDel) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ViewHolder holder;
        if (convertView == null) {
            convertView = View.inflate(mCxontext, R.layout.list_item_missiondetails, null);
...
//        ImageLoader.getInstance().displayImage(mBaseUrl + entity.getPersonCreateHeadUrl(), holder.mPortrait);
        //姓名
        holder.mName.setText(entity.getCreatorName());
        //子任务进度
        holder.tv_progress.setText(entity.getProgress() + "" + "%");
        holder.childTitle.setText(entity.getTitle());
        ...
        final String childId = entity.getTaskId() + "";
