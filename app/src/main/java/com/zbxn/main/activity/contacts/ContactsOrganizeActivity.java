 ...
 * 创建时间：2016/11/1 8:52
 */
public class ContactsOrganizeActivity extends BaseActivity{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView( R.layout.activity_contacts_organize);
            ...
            mListViewPeople.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    if (mType == 0) {
                        ...
                        intent = new Intent(ContactsOrganizeActivity.this, ContactsDetailActivity.class);
