...
import com.zbxn.R;
import com.zbxn.main.entity.MessageUpdateEntity;
 ...
 */
public class MessageSettings extends BaseActivity{
    ...
    public void changeUrl() {
        ...
        Call call = HttpRequest.getIResourceOA().MessageSettingInfo(ssid);
        callRequest(call, new HttpCallBack(MessageUpdateEntity.class,this,true) {
            @Override
    ...
    public void submitUrl() {
        ...
        Call call = HttpRequest.getIResourceOA().MessageSettingSet(ssid,pushState,isPush);
        callRequest(call, new HttpCallBack(MessageUpdateEntity.class,this,true) {
            @Override
            public void onSuccess(ResultData mResult) {
