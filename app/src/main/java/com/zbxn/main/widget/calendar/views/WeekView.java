...
//						}
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        setMeasuredDimension(measureWidth, (int) (measureWidth / 7F - 20) + 20);
    }
    ...
    public void defineRegion(final int x, final int y) {
        ...
        for (int i = 0; i < tmp.length; i++) {
            ...
            for (int j = 0; j < tmp[num].length; j++) {
                //设置是否选中
                mCManager.getDateInfo(centerYear, centerMonth, false)[num][j].isChoosed = false;
                ...
                if (region.contains(x, y)) {
                    //设置是否选中
                    mCManager.getDateInfo(centerYear, centerMonth, false)[num][j].isChoosed = true;
