 ...
 */
public class CustomPoolActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String stateStr = PreferencesUtils.getString(CustomPoolActivity.this, CustomActivity.CUSTPUBLICPOOL);
    ...
    private void initView() {
        ...
        listViewIndustry.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                industry.putExtra("pool", mList.get(position).getValue());
