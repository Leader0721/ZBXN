 ...
 */
public class CustomSourceActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String stateStr = PreferencesUtils.getString(CustomSourceActivity.this, CustomActivity.CUSTSOURCE);
    ...
    private void initView() {
        ...
        listViewIndustry.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                industry.putExtra("source", mList.get(position).getValue());
